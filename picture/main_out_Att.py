...
class Main():
    def __init__(self, train_config, env_config, debug=False):
        ...
        self.val_dataloader = DataLoader(test_dataset, batch_size=train_config['batch'], shuffle=False, num_workers=0,
                                         drop_last=True)
    ...
    def run(self):
        ...
        model_save_path = './Ablation_results/All/best_no_bnoutlayer_avgpool2d/best_07|17-09:45:38.pt'
        self.model = torch.load(model_save_path)
        print(self.model)
        best_model = self.model.to(self.device)
        print(best_model.learned_graph)
    ...
    def get_save_path(self, feature_name=''):
        ...
        paths = [
            f'./pretrained_7_test/{dir_path}/best_{datestr}.pt',
...
if __name__ == "__main__":
    ...
    parser.add_argument('-save_path_pattern', help='save path pattern', type=str, default='GDN_Linear')
    ...
    parser.add_argument('-topk', help='topk num', type=int, default=3)  # 与每个特征最相关的topk个特征，3取得最好的效果
...
# CUDA_VISIBLE_DEVICES=1 python -u main_GDN_AR_TCN.py |tee ./save_log_7/GDN_AR_TCN/batch_size_32/k_3/lr_0.001/kernel_set_2_6/TC_layer_3/dilation_exponential_1/solar_48_24
# CUDA_VISIBLE_DEVICES=1 python -u main_GDN_AR_Attention_TCN.py -slide_win 24 -predict_length 24 -batch 32 -topk 3 |tee ./save_log_7/GDN_AR_Attention_TCN/batch_size_32/k_3/lr_0.0005/kernel_set_2_6/TC_layer_3/dilation_exponential_1/solar_24_24
